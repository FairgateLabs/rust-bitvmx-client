...
impl BitVMX {
    ...
    pub fn shutdown(&mut self, timeout: Duration) -> Result<(), BitVMXError> {
        ...
        // Programs automatically save their state during tick(), so no explicit save needed here
    ...
    pub fn process_comms_messages(&mut self) -> Result<(), BitVMXError> {
        ...
        match message {
            ReceiveHandlerChannel::Msg(identifier, msg) => {
                info!("BitVMX::process_comms_messages() - Received message from {}", identifier);
